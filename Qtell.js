...
async function 𝓜𝓮𝓮6s() {
  ...
  if (_𝔏𝔞𝔟_.HEROKU_API === `Null` || _𝔏𝔞𝔟_.HEROKU_BOT_NAME === `Null`) {
    console.log(
      Kolor.yellow.bold(
        `𝐐𝐭𝐞𝐥𝐥™❌𝗘𝗿𝗿𝗼𝗿⬰ 𝐒𝐞𝐞𝐦𝐬 𝐥𝐢𝐤𝐞 𝐇𝐞𝐫𝐨𝐤𝐮 𝐯𝐚𝐫𝐬 𝐚𝐫𝐞 𝐢𝐧𝐯𝐚𝐥𝐢𝐝.𝐏𝐥𝐞𝐚𝐬𝐞 𝐜𝐡𝐞𝐜𝐤 𝐚𝐧𝐝 𝐫𝐞𝐭𝐫𝐲!`
      )
    );
    process.exit(0);
  }
  console.log(
    Kolor.yellow.bold(`⬡=================⬡    ⦿𝐐𝐭𝐞𝐥𝐥™⦿    ⬡=================⬡`)
  );
  console.log(
    Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰ 𝗖𝗵𝗲𝗰𝗸𝗶𝗻𝗴 𝗳𝗼𝗿 𝘂𝗽𝗱𝗮𝘁𝗲𝘀...`)
  );
  // await AutoKrakz();
  try {
  ...
  𝓚𝓻𝓪𝓴𝓲𝓷𝔃.on(`connecting`, async () => {
    ...
    console.log(
      Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  𝘊𝘰𝘯𝘯𝘦𝘤𝘵𝘪𝘯𝘨 𝘵𝘰 𝘞𝘩𝘢𝘵𝘴𝘈𝘱𝘱...🤖`)
    );
  });
  // ⬡==================⬡-----------------⦿𝐐𝐭𝐞𝐥𝐥™⦿-----------------⬡==================⬡
  // 👓𝐐𝐭𝐞𝐥𝐥™ ᴀᴅᴠᴀɴᴄᴇᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀʙᴏᴛ ᴡɪᴛʜ 100+ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ʙᴏᴛʜ ᴘʀɪᴠᴀᴛᴇ ᴀɴᴅ ɢʀᴏᴜᴘ-ᴜꜱᴀɢᴇ👓
  ...
  𝓚𝓻𝓪𝓴𝓲𝓷𝔃.on(`open`, async () => {
    ...
    console.log(
      Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  𝘊𝘰𝘯𝘯𝘦𝘤𝘵𝘪𝘯𝘨 𝘵𝘰 𝘋𝘢𝘵𝘢𝘣𝘢𝘴𝘦...✅`)
    );
    try {
      await 𝓜𝖎𝖟𝖚ӄ𝖎sql.authenticate();
    } catch (error) {
      console.error(
        `𝐐𝐭𝐞𝐥𝐥™❌𝗘𝗿𝗿𝗼𝗿⬰ 𝗨𝗻𝗮𝗯𝗹𝗲 𝘁𝗼 𝗰𝗼𝗻𝗻𝗲𝗰𝘁 𝘁𝗼 𝘁𝗵𝗲 𝗱𝗮𝘁𝗮𝗯𝗮𝘀𝗲:`,
        error
      );
    }
    console.log(
    ...
    console.log(
      Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  𝘚𝘺𝘯𝘤𝘪𝘯𝘨 𝘋𝘢𝘵𝘢 𝘸𝘪𝘵𝘩 𝘏𝘰𝘴𝘵...✅`)
    );
    ...
    console.log(
      Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  𝘐𝘯𝘴𝘵𝘢𝘭𝘭𝘪𝘯𝘨 𝘗𝘭𝘶𝘨𝘪𝘯𝘴...✅`)
    );
    ...
    for (const folder of Folders) {
      ...
      for (const file of commandFiles) {
        ...
        console.log(
          Kolor.yellow.bold(`𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  `),
...
⧪ 𝐐𝐭𝐞𝐥𝐥 ɪꜱ ᴡʀɪᴛᴛᴇɴ ɪɴ ᴊᴀᴠᴀꜱᴄʀɪᴘᴛ ᴀɴᴅ ɪꜱ ʙʏ ꜰᴀʀ ᴛʜᴇ ᴍᴏꜱᴛ ᴀᴅᴠᴀɴᴄᴇ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀʙᴏᴛ.
⧪ ᴜꜱᴇ 𝐐𝐭𝐞𝐥𝐥 ɪɴ ʙᴏᴛʜ ᴘᴜʙʟɪᴄ-ɢʀᴏᴜᴘꜱ ᴀɴᴅ ᴘʀɪᴠᴀᴛᴇ
...
⦿ 𝗦𝘂𝗽𝗽𝗼𝗿𝘁 𝐆𝐫𝐨𝐮𝐩👓 https://chat.whatsapp.com/Ltg5YukK5Ug2a1mBsFhtFi`,
        `conversation`
      );
    }
...
${ꜰᴇᴛᴄʜᴇᴅʙʏᴇ.message}`,
  ...
  𝓚𝓻𝓪𝓴𝓲𝓷𝔃.on(`chat-update`, async (chat) => {
    ...
    if (𝓜𝖎𝖟𝖚ӄ𝖎.isCmd) {
      console.log(
        Kolor.green.bold(
          `𝐐𝐭𝐞𝐥𝐥™💡𝗜𝗻𝗳𝗼𝗿𝗺𝗮𝘁𝗶𝗼𝗻⬰  ${𝓜𝖎𝖟𝖚ӄ𝖎.commandName.toUpperCase()} command executed.`
        )
      );
...
Use ${ᴋᴇɪ}help to get the list of available commands`,
        ...
        try {
          ...
          return console.log(Kolor.red.bold(`𝐐𝐭𝐞𝐥𝐥™❌𝗘𝗿𝗿𝗼𝗿⬰ `, cᴇʀʀᴏʀ));
        }
      }
...
𝓜𝓮𝓮6s().catch((cᴇʀʀᴏʀ) =>
  console.log(Kolor.red.bold(`𝐐𝐭𝐞𝐥𝐥™❌𝗘𝗿𝗿𝗼𝗿⬰`), Kolor.red.bold(cᴇʀʀᴏʀ))
);
// ⬡==================⬡-----------------⦿𝐐𝐭𝐞𝐥𝐥™⦿-----------------⬡==================⬡
// 👓𝐐𝐭𝐞𝐥𝐥™ ᴀᴅᴠᴀɴᴄᴇᴅ ᴡʜᴀᴛꜱᴀᴘᴘ ᴜꜱᴇʀʙᴏᴛ ᴡɪᴛʜ 100+ ᴄᴏᴍᴍᴀɴᴅꜱ ꜰᴏʀ ʙᴏᴛʜ ᴘʀɪᴠᴀᴛᴇ ᴀɴᴅ ɢʀᴏᴜᴘ-ᴜꜱᴀɢᴇ👓
// ⬡==================⬡-----------------⦿𝐐𝐭𝐞𝐥𝐥™⦿-----------------⬡=================
